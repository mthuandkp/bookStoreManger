 ...
 * @author MINHTHUAN
 */
public class ThongKePN extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThongKePN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void drawChart(int year) {
        ArrayList<String []> data = pnbus.getDataBarChart(year);
        ArrayList<String []> dataMonth = pnbus.getDataLineChart(year);
        ProcessingFunction.ThongKe.lineChart(data, "Thống kê phiếu nhập theo tổng tiền", "Phiếu nhâp", "Tổng", barChart);
        ProcessingFunction.ThongKe.barChart(dataMonth, "Thống kê Phiếu Nhập theo tháng", "Tháng", "Tổng(Triệu VNĐ)", barChartMonth);
    }
